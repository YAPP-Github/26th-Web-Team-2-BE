...
public enum AmenityFactor {
     ...
     */
    public static List<AmenityFactor> convertToAmenityFactorList(List<String> factorNames) {
        return factorNames.stream()
                .map(name -> Arrays.stream(AmenityFactor.values())
